...
class UserInfoHeaderVC: UIViewController {
    ...
    let avatarImageView = AppImageView(frame: .zero)
    let usernameLabel = TitleLabel(textAlignment: .left, fontSize: 34)
    let nameLabel = SubtitleLabel(fontSize: 18)
    let locationImageView = UIImageView()
    let locationLabel = SubtitleLabel(fontSize: 18)
    ...
    func downloadAvatar(for user: User) {
